...
<section class="products">
   ...
   <form action="" method="POST" class="box">
      ...
      <div class="flex">
         <p class="price"><i class="fa-solid fa-dollar-sign"></i> <?= $fetch_cart['price']; ?></p>
      ...
      <p class="sub-total">Sub total : <span><i class="fa-solid fa-dollar-sign"></i> <?= $sub_total = ($fetch_cart['qty'] * $fetch_cart['price']); ?></span></p>
   ...
   <?php if($grand_total != 0){ ?>
      <div class="cart-total">
         ...
         <a href="view_products.php" class="option-btn">continue shopping</a>
